...
void InitializeAPIs()
{
	...
	// 库操作
	INSERT_FUNC(api_db_open,		"DBOpen");
	INSERT_FUNC(api_db_close,		"DBClose");

	// 记录的操作
	INSERT_FUNC(api_db_recordcount,	"DBRecordCount");
	INSERT_FUNC(api_db_recordNo,	"DBRecordNo");
	INSERT_FUNC(api_db_delete,		"DBDelete");
	INSERT_FUNC(api_db_update,		"DBUpdate");
	INSERT_FUNC(api_db_blank,		"DBBlank");
	INSERT_FUNC(api_db_appendblank,	"DBAppendBlank");
	INSERT_FUNC(api_db_append,		"DBAppend");
	INSERT_FUNC(api_db_moveto,		"DBMoveTo");
	INSERT_FUNC(api_db_movenext,	"DBMoveNext");
	INSERT_FUNC(api_db_movelast,	"DBMoveLast");
	INSERT_FUNC(api_db_moveFirst,	"DBMoveFirst");
	INSERT_FUNC(api_db_eof,			"DBEof");
	INSERT_FUNC(api_db_isdelete,	"DBIsDelete");

	INSERT_FUNC(api_db_getmemo,		"DBGetMemo");
	INSERT_FUNC(api_db_updatememo,	"DBUpdateMemo");


	INSERT_FUNC(api_db_locate,		"DBLocate");

	INSERT_FUNC(api_db_seek,		"DBSeek");
	INSERT_FUNC(api_db_count,		"DBCount");
	INSERT_FUNC(api_db_sum,			"DBSum");
